...
with gr.Blocks(title="Food Order Bot") as demo:
    ...
    demo.load(load_greeting, outputs=[chatbot, session_id_state, username_state, password_state])
    
    chat_input.submit(chat_function, inputs=[chat_input, chatbot, session_id_state, username_state, password_state], outputs=[chatbot, chat_input, username_state, password_state])
    voice_input.change(voice_function, inputs=[voice_input, chatbot, session_id_state, username_state, password_state], outputs=[chatbot, username_state, password_state])
