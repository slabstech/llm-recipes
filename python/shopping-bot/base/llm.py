...
async def process_with_tools(
    user_input: str, session_data: Dict, tools: List[Dict] = TOOLS
    ...
    messages = [
        {
            "role": "system",
            "content": "You are a food order bot. Use the provided tools to handle user queries. Respond naturally and call tools as needed.",
        },
    ...
    try:
        ...
        return (
            "Sorry, I couldn't process your request due to an internal error. Please try again.",
            None,
        )
